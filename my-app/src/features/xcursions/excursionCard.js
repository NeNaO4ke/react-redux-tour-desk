        ...
        <div className="excursionCard card-body"
            ...
            <div className="excursionInfo d-flex flex-column justify-content-between py-2">
                ...
                <div className="d-flex justify-content-between">
                    <span className='d-flex'>{props.currentLoad}/{props.maxLoad}<i className="ps-1 bi bi-people"></i></span>
                    <span className='d-flex'><i className="bi bi-wallet2 pe-1"></i>{props.cost} {props.currency}</span>
                </div>
            </div>
